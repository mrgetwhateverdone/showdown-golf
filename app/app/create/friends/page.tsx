...
export default function CreateFriendsMatch() {
  const { user } = useAuth()
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      toast({
        title: "Match Created!",
        description: "Your match has been created and is waiting for players",
      })
  ...
  const handleTeamsConfirmed = (teamBlue: any[], teamRed: any[]) => {
    // This would be called when teams are confirmed
    // For now, just close the modal - actual team logic would be implemented in match flow
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="p-4">
        ...
        <div className="space-y-6">
          ...
          >
            {isCreating ? "Creating Challenge..." : "Post Challenge"}
          </Button>
        </div>
      </div>

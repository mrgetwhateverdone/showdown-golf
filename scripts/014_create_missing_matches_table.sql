-- CRITICAL FIX: Create the missing matches table that should have been created initially
-- This fixes the 400 Bad Request errors when creating matches
...
CREATE TABLE IF NOT EXISTS public.transactions (
  ...
  transaction_type TEXT NOT NULL CHECK (transaction_type IN ('wager', 'prize', 'refund', 'deposit', 'withdrawal', 'winnings')),
